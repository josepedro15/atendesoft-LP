...
class Title {
  ...
  createMesh() {
    const { texture, width, height } = createIconTexture(this.gl, this.text, '#ffffff', '#000000', 200);
...
class Media {
  ...
  createShader() {
    const { texture } = createIconTexture(this.gl, this.icon, this.backgroundColor, this.iconColor, 400);
...
interface AppConfig {
  items?: { icon: string; text: string; backgroundColor?: string; iconColor?: string }[];
  bend?: number;
  textColor?: string;
  borderRadius?: number;
  font?: string;
...
class App {
  ...
  planeGeometry!: Plane;
  medias: Media[] = [];
  mediasImages: { icon: string; text: string; backgroundColor?: string; iconColor?: string }[] = [];
  ...
  createMedias(
    items: { icon: string; text: string; backgroundColor?: string; iconColor?: string }[] | undefined,
    bend: number = 1,
    textColor: string,
    borderRadius: number,
    font: string
